...
public class Camera_Overlay_View_Portrait extends View {

    private Paint paint;
    private Paint bracketPaint;
    private RectF rect;

    public Camera_Overlay_View_Portrait(Context context) {
        super(context);
        init();
    }

    public Camera_Overlay_View_Portrait(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Camera_Overlay_View_Portrait(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
