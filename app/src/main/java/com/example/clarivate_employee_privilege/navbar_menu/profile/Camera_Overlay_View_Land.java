...
public class Camera_Overlay_View_Land extends View {

    private Paint paint;
    private Paint bracketPaint;
    private RectF rect;

    public Camera_Overlay_View_Land(Context context) {
        super(context);
        init();
    }

    public Camera_Overlay_View_Land(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Camera_Overlay_View_Land(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
