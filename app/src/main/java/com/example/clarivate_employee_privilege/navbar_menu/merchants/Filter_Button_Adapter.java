...
public class Filter_Button_Adapter extends RecyclerView.Adapter<Filter_Button_Adapter.ButtonViewHolder> {
    ...
    public Filter_Button_Adapter(List<String> buttonList, OnButtonClickListener onButtonClickListener) {
